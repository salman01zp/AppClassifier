...
with open("E:/classifier/data/PlayStoreData.csv" ) as the_file:
    ...
    with open("E:/classifier/data/PlayStoreDataTopDevelopers.csv", "w+") as to_file1:
        writer1 = csv.writer(to_file1, delimiter=",")
        for top_row in dataTop:
            writer1.writerow(top_row)

    #list of non top developers
    with open("E:/classifier/data/PlayStoreDataOthers.csv", "w+") as to_file2:
