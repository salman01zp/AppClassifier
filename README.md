...
AppClassifier uses NaiveBayes Classifier to classify the app into their respective Category

## Pre-requisites
* Install python Anaconda 3.6 for windows . It comes with almost all th python packages
